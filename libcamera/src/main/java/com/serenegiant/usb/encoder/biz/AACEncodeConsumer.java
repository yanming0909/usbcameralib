...
//                    }
                    ...
                    if(listener != null){
//                        if (USBMonitor.DEBUG)Log.i(TAG,"----->得到aac数据流<-----");
                        listener.onEncodeResult(mBuffer.array(),0, mBufferInfo.size + 7, mBufferInfo.presentationTimeUs / 1000,0);
                    }
                }
                // 处理结束，释放输出缓存区资源
    ...
    private void initAudioRecord(){
        ...
        try {
            ...
            Log.d(TAG, "mAudioRecord.startRecording: error");
        }
    }
